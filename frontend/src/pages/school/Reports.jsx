...
const reportStats = [
  ...
  { icon: 'share', label: 'Shared', value: '156', change: '+24', helper: 'Reports', tone: 'rose' },
  { icon: 'trending_up', label: 'Most Viewed', value: 'Attendance', change: '320', helper: 'Views', tone: 'purple' },
  { icon: 'schedule', label: 'Scheduled', value: '8', change: '+2', helper: 'Auto-reports', tone: 'green' },
];

const reports = [
  { id: 1, name: 'Attendance Report - January 2024', type: 'Attendance', format: 'PDF', generatedDate: '2024-01-25', generatedBy: 'System', size: '2.4 MB', views: 320, downloads: 145, status: 'available' },
  { id: 2, name: 'Student Strength Report', type: 'Admissions', format: 'Excel', generatedDate: '2024-01-24', generatedBy: 'Admin', size: '1.2 MB', views: 180, downloads: 85, status: 'available' },
  { id: 3, name: 'Fee Collection Summary', type: 'Finance', format: 'PDF', generatedDate: '2024-01-23', generatedBy: 'Finance', size: '3.1 MB', views: 145, downloads: 78, status: 'available' },
  { id: 4, name: 'Academic Performance', type: 'Results', format: 'PDF', generatedDate: '2024-01-22', generatedBy: 'Academic', size: '4.5 MB', views: 210, downloads: 92, status: 'available' },
  { id: 5, name: 'Teacher Attendance', type: 'Staff', format: 'Excel', generatedDate: '2024-01-21', generatedBy: 'HR', size: '0.8 MB', views: 85, downloads: 42, status: 'available' },
  { id: 6, name: 'Monthly Fee Defaulters', type: 'Finance', format: 'PDF', generatedDate: '2024-01-20', generatedBy: 'System', size: '1.5 MB', views: 95, downloads: 55, status: 'available' },
  { id: 7, name: 'Student Directory', type: 'Admissions', format: 'Excel', generatedDate: '2024-01-19', generatedBy: 'Admin', size: '2.8 MB', views: 120, downloads: 68, status: 'available' },
  { id: 8, name: 'Exam Schedule', type: 'Academic', format: 'PDF', generatedDate: '2024-01-18', generatedBy: 'Academic', size: '0.5 MB', views: 180, downloads: 90, status: 'available' },
  { id: 9, name: 'Transport Route Details', type: 'Transport', format: 'Excel', generatedDate: '2024-01-17', generatedBy: 'Transport', size: '1.1 MB', views: 45, downloads: 22, status: 'available' },
  { id: 10, name: 'Library Book Status', type: 'Library', format: 'PDF', generatedDate: '2024-01-16', generatedBy: 'Librarian', size: '0.9 MB', views: 65, downloads: 35, status: 'available' },
];
...
export default function Reports() {
  ...
  return (
    ...
    >
      ...
      <SectionCard title="Available Reports" description="Generate and download school reports">
